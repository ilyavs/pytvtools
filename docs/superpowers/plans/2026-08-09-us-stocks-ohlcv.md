...
- Live job IDs: daily `795017445883903` (1D), weekly `936004519313878` (1W), monthly `495785726036702` (1M), on-demand `646435410260973`. Live jobs' `git_source` is `ilyavs/pytvtools-core @ main` (verified). Template JSONs in `pytvtools-core-public/jobs/` currently say `ilyavs/pytvtools-core-public @ master` — fix them.
